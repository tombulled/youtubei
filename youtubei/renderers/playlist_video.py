...
from youtubei.renderers.thumbnail_overlay_now_playing import ThumbnailOverlayNowPlayingRenderer
from youtubei.renderers.thumbnail_overlay_time_status import ThumbnailOverlayTimeStatusRenderer
